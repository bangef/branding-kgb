...
export default function index(props) {
	return (
		<article ref={props.directTo}>
			<section
				className="grid h-auto grid-cols-1 p-3 px-4 py-16 mx-auto xl:rounded-lg xl:container bg-red-cstm-1"
				style={{
			...
			>
				<div className="xl:mr-10 lg:mr-8 md:mr-4 ">
					...
					<div className="grid w-full gap-3 p-3 mt-8"></div>
					<div>
						<Carousel delay={2000} />
					</div>
				</div>
